...
class FNN(object):
    ...
    def forwardprop(self, data, labels=None):
        ...
        probability  among labels (probs), and
...
class Layer(object):
    ...
    def backward(self, d_outputs):
        ...
        #     H is the number of hidden units in this layer.
        self.d_b = np.dot(np.ones(d_scores.shape[0]),d_scores)
        # self.d_w:
        ...
        #d_inputs = np.transpose(d_scores),self.w
        #d_inputs = np.dot(d_scores,weights)
